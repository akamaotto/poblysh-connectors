...
- AAD: ASCII bytes of `tenant_id | provider_slug | external_id` concatenated with `|` separators to bind ciphertext to its connection context.
- Payload format: `0x01 | nonce(12) | ciphertext | tag(16)` stored verbatim in `BYTEA` columns.
