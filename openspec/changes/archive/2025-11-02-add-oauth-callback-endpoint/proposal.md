...
- Errors: 400 for invalid/missing state or code; 502 for upstream provider HTTP failures as defined in api-core; application/problem+json error envelope as defined in api-core specification.
